...
import { IconNotes, IconDashboard, IconClipboard, IconChecklist, IconUserCheck, IconCashBanknote, IconReceipt, IconUser, IconClock, IconFileText, IconFileInvoice, IconChartBar, IconMessageCircle2 } from "@tabler/icons";
  ...
  const createFranchiseSideBarMenus = async () => {
      ...
      const baseMenus = [
        {
          ...
          menuId: "franchise-dashboard", // Must match tblMenu.MenuId (PopulateDefaultMenus)
        },
        {
          id: 2,
          label: "Planboard",
    ...
    const additionalMenus = [
      ...
      },
      {
        ...
        link: `/franchises/${franchiseName}/copilot`,
        menuId: "ai-copilot"
      }
    ];
