...
export function FranchiseAssignment({ userId, readOnly = false }) {
  ...
  return (
    <ProfileTabPanel
      ...
      description="Franchises this user can access within the organization."
    >
    <Paper p={0} shadow="none" style={{ position: "relative" }}>
            ...
            <Table highlightOnHover>
              ...
              <tbody>
                {userFranchises.map((franchise) => (
                  <tr key={franchise.id}>
                    <td>
                      <TruncatedTooltipText value={franchise.franchiseName} maxWidth={240} weight={500} />
                    </td>
                    <td>
