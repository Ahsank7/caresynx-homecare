...
import { ClientPayerAndBilling } from "shared/components/user/ClientPayerAndBilling";
  ...
  const RenderSelectedTabPanel = (activeTab) => {
    switch (activeTab) {
      ...
      case "Invoice preferences":
        return (
          <Tabs.Panel value="Invoice preferences" className={classes.panel}>
            <ClientPayerAndBilling
              clientId={userID}
              organizationId={organizationId}
              readOnly={readOnly}
            />
