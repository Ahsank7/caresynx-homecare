...
const ContactPage = () => {
  ...
  const form = useForm({
    ...
    validate: {
      ...
      captchaAnswer: (value) => (isCaptchaValid(value, captcha.answer) ? null : "Please solve the security check"),
    },
  });
  ...
  const refreshCaptcha = () => {
    ...
    form.clearFieldError("captchaAnswer");
  };
              ...
              >
                ...
                <form onSubmit={form.onSubmit(handleSubmit)}>
                  <Stack spacing="md">
                    ...
                    <SimpleCaptcha
                      challenge={captcha}
                      inputProps={form.getInputProps("captchaAnswer")}
