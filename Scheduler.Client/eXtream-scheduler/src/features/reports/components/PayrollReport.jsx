    ...
    <>
        ...
        <Stack spacing="md">
          <div>
            ...
            <Text size="lg" weight={700} color="dark">
              Focus the payroll range before export
            </Text>
            <Text size="sm" color="dimmed" mt={4}>
              Pick a date range and optionally narrow this view to one service provider.
            </Text>
          </div>
      ...
      {reportData && !isLoading && (
        ...
        >
          ...
          <div className="section-caption">A quick view of payroll volume, totals, and provider coverage.</div>
          ...
          <div className="section-caption">Payment-level payroll rows included in this report.</div>
          ...
          <div className="section-caption">Paid and pending payroll values for the selected period.</div>
      ...
      {!reportData && !isLoading && (
        ...
        >
          <Text size="lg" weight={700} color="dark" mb={6}>
            Payroll report preview is waiting
          </Text>
