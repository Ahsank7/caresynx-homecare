...
import { Stack, Group, Button, Text, Paper, LoadingOverlay, Grid, TextInput } from '@mantine/core';
  ...
  return (
    <>
        ...
        <Stack spacing="md">
          <div>
            ...
            <Text size="lg" weight={700} color="dark">
              Build a cleaner operational summary
            </Text>
            <Text size="sm" color="dimmed" mt={4}>
              Choose the reporting range and generate an overview of workload and task outcomes.
            </Text>
          </div>
      ...
      {reportData && !isLoading && (
        ...
        >
          <div className="section-title">Task Snapshot</div>
          <div className="section-caption">A quick operational summary across the selected reporting period.</div>
          ...
          <div className="section-caption">Status mix shown as simple visual tally cards.</div>
          ...
          <div className="section-caption">Detailed rows for each task currently included in the report.</div>
      ...
      {!reportData && !isLoading && (
        ...
        >
          <Text size="lg" weight={700} color="dark" mb={6}>
            Task summary preview is waiting
          </Text>
