  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (roleId !== 6 && roleId !== "6") {
        notifications.show({
          title: "Access Denied",
          message: "This portal is only for Super Administrators.",
          color: "red",
        });
        localStoreService.clearLocalStorage();
        return;
        ...
        <Card className={classes.loginCard}>
          ...
          <Stack spacing="md">
            ...
            <Alert
              ...
              variant="light"
            >
              This portal is exclusively for Super Administrators. Please use your
              assigned credentials to access organization and
