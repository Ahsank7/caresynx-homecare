...
const schema = zod.object({
  ...
  captchaAnswer: zod.string().min(1, "Security check is required"),
});
...
const Login = () => {
  ...
  const handleSubmit = async (values) => {
    if (!isCaptchaValid(values.captchaAnswer, captcha.answer)) {
      form.setFieldError("captchaAnswer", "Please solve the security check.");
      return;
    }
