...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO [dbo].[tblNotification] (
            Id, Title, Message, Type, Priority, OrganizationId, FranchiseId,
            TargetRoleId, TargetUserId, ActivityType, ActivityEntity, ActivityEntityId,
            ActionUrl, CreatedBy, CreatedDate, IsActive, ExpiresAt
        )
        VALUES (
            @NotificationId, @Title, @Message, @Type, @Priority, @OrganizationId, @FranchiseId,
            @TargetRoleId, @TargetUserId, @ActivityType, @ActivityEntity, @ActivityEntityId,
            @ActionUrl, @CreatedBy, GETDATE(), 1, @ExpiresAt
        );
