...
-- =============================================
CREATE PROCEDURE [dbo].[uspGetToConfirmTasks] 
...
select st.Id as TaskId 
    ...
    ,DATEADD(
	  ...
	  ,st.IsConfirmed
	  --,st.IsBillingConfirmed
	  --,st.IsPayrollConfirmed
...
--	@pTaskStatusIds =null,
--	@pClientName =null,
--	@pClientPhoneNumber =null,
--	@pServiceProviderId =null,
--	@pServiceProviderName =null,
--	@pSortColumn  ='TaskId',
--	@pSortType ='asc' ,
--	@PageNumber  =1,
--	@pPageSize  =10
